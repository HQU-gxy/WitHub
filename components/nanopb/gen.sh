...
#$SCRIPT_DIR/nanopb/generator/nanopb_generator.py -I $PROTO_DIR -D $OUT_DIR $PROTO_DIR/wlan.proto
#$SCRIPT_DIR/nanopb/generator/nanopb_generator.py -I $PROTO_DIR -D $OUT_DIR $PROTO_DIR/track.proto
